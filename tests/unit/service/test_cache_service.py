...
class TestCacheService:
    ...
    async def test_successfully_get_key_value(self, cache_service, settings, httpx_mock):
    ...
    async def test_successfully_get_key_value_with_invalid_id(self, cache_service, settings, httpx_mock):
